...
# RailsAdmin config file. Generated on October 13, 2011 07:47
...
RailsAdmin.config do |config|
  ...
  config.main_app_name { ['Locamotiva', 'Admin'] } # auto-generated
  ...
  # config.excluded_models << [Race, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Race, User]
